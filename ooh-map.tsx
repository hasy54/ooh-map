...
export default function OOHMap() {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      try {
        ...
        console.log("Fetching all listings with client-side filtering")

        const fetchedListings = await MediaService.getListings({
          // Remove city filter - now handled client-side in the service
          // city: selectedCity === "all" ? undefined : selectedCity === "mumbai" ? "Mumbai" : undefined,
        })

        console.log("Filtered listings count:", fetchedListings.length)
    ...
    fetchListings()
  }, [searchQuery, filters]) // Remove selectedCity from dependencies since filtering is now client-side
  ...
  const filteredListings = useMemo(() => {
    ...
    if (selectedCity && selectedCity !== "all") {
      const cityName = selectedCity === "mumbai" ? "Mumbai" : selectedCity
      console.log("Applying city filter:", cityName)
      filtered = filtered.filter((listing) => listing.location.city.toLowerCase() === cityName.toLowerCase())
    ...
    return filtered
  }, [listings, filters.types, sortBy, selectedTypeFilter, selectedCity])
                    ...
                    <Tabs defaultValue="overview" className="w-full">
                      ...
                      <TabsContent value="description" className="space-y-3 mt-4">
                        <div className="text-sm text-gray-700 leading-relaxed">
                          <p>
                            Discover premium outdoor advertising and hoarding opportunities at {selectedListing.name}.
                            This {selectedListing.type} in {selectedListing.location.city} offers exceptional visibility
                            for brands seeking impactful outdoor advertising solutions across India's major metropolitan
                            areas.
                          </p>
                          <p className="mt-2">
                            Our outdoor advertising network spans Mumbai, Delhi, Bangalore, Chennai, Hyderabad, Kolkata,
                            Pune, Ahmedabad, Jaipur, and Lucknow, making this hoarding space part of India's largest
                            outdoor advertising ecosystem. With {selectedListing.specifications.visibility} visibility,
                            this location delivers maximum impact for your outdoor advertising campaigns.
                          </p>
                          <p className="mt-2">
                            Currently marked as '{selectedListing.availability}', this hoarding presents an immediate
                            opportunity for brands looking to dominate outdoor advertising in{" "}
                            {selectedListing.location.city}. The {selectedListing.specifications.illumination} display
                            ensures 24/7 visibility, perfect for comprehensive outdoor advertising strategies across
                            India's competitive markets.
                          </p>
                          <p className="mt-2">
                            Book this premium hoarding location now and join leading brands who trust our outdoor
                            advertising solutions across Mumbai, Delhi, Bangalore, and other major Indian cities. This{" "}
                            {selectedListing.type} is professionally managed, ensuring reliable outdoor advertising
                            operations and maximum ROI for your campaigns.
                          </p>
                        </div>
                      </TabsContent>
                    </Tabs>
                    ...
                    <TabsContent value="description" className="space-y-4 mt-4">
                      <div className="text-gray-700 leading-relaxed">
                        ...
                        <p className="mt-3">
                          Our outdoor advertising network spans Mumbai, Delhi, Bangalore, Chennai, Hyderabad, Kolkata,
                          Pune, Ahmedabad, Jaipur, and Lucknow, making this hoarding space part of India's largest
                          outdoor advertising ecosystem. With {selectedListing.specifications.visibility} visibility and{" "}
                          {selectedListing.specifications.size} display area, this location delivers maximum impact for
                        ...
                        <p className="mt-3">
                          ...
                          opportunity for brands looking to dominate outdoor advertising in{" "}
                          {selectedListing.location.city}. The {selectedListing.specifications.illumination} display
                          ensures 24/7 visibility, making it perfect for comprehensive outdoor advertising strategies
                          across India's competitive markets.
                        </p>
                        <p className="mt-3">
                          Book this premium hoarding location now and join leading brands who trust our outdoor
                          advertising solutions across Mumbai, Delhi, Bangalore, and other major Indian cities. This{" "}
