...
export default function OOHMap() {
  ...
  const generateSEOContent = () => {
    const cityText = selectedCity === "all" ? "India" : selectedCity === "mumbai" ? "Mumbai" : selectedCity
    const typeText = selectedTypeFilter ? ` ${selectedTypeFilter}` : ""
    const countText = filteredListings.length

    return {
      title: `${countText}${typeText} OOH Advertising Spaces in ${cityText} | Book Billboards & Hoardings`,
      description: `Find and book ${countText} premium${typeText} outdoor advertising spaces in ${cityText}. Compare prices, locations, and availability for billboards, digital displays, and transit ads. Start your OOH campaign today.`,
      keywords: `OOH advertising ${cityText}, billboards ${cityText}, outdoor advertising, hoardings ${cityText}, digital displays, transit advertising, ${typeText} advertising`,
    }
  }
  ...
  return (
    <>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: "India's premier platform for discovering and booking outdoor advertising spaces",
              ...
              provider: {
                "@type": "Organization",
                name: "OOH Advertising India",
                description: "Leading outdoor advertising platform in India",
              },
            }),
          }}
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "ItemList",
              name: `OOH Advertising Spaces in ${selectedCity === "all" ? "India" : selectedCity}`,
              description: `Collection of ${filteredListings.length} outdoor advertising spaces available for booking`,
              ...
              itemListElement: filteredListings.slice(0, 10).map((listing, index) => ({
                ...
                item: {
                  "@type": "Product",
                  name: listing.name,
                  description: `Discover premium ${listing.type} advertising at ${listing.name}. Located in ${listing.location.city}, this site offers ${listing.specifications.visibility} visibility and is an ideal spot for brands looking to capture daily foot traffic.`,
      ...
      <div className="h-screen flex flex-col overflow-hidden">
        {/* Hidden SEO content for current page state */}
        <div className="sr-only" aria-hidden="true">
          <h1>OOH Advertising Spaces in {selectedCity === "all" ? "India" : selectedCity}</h1>
          <p>
            Explore {filteredListings.length} premium outdoor advertising opportunities in{" "}
            {selectedCity === "all" ? "India" : selectedCity}. Our platform offers comprehensive listings of billboards,
            digital displays, transit advertising, and street furniture across major Indian cities. Each listing
            provides detailed information about size, location, pricing, and availability to help you make informed
            decisions for your advertising campaigns.
          </p>
          {selectedTypeFilter && (
            <p>
              Currently viewing {selectedTypeFilter} advertising spaces. These locations offer excellent visibility and
              are perfect for brands looking to maximize their outdoor advertising impact.
            </p>
          )}
        </div>
